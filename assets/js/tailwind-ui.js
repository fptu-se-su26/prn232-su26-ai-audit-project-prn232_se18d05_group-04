(function () {
  const classMap = {
    "app-shell": "min-h-[100dvh] bg-zinc-50 lg:pl-[280px]",
    "owner-grid": "grid min-h-[100dvh] grid-cols-[280px_minmax(0,1fr)] max-lg:grid-cols-1",
    "main-shell": "min-w-0 bg-zinc-50",
    "admin-sidebar": "fixed inset-y-0 left-0 z-40 flex h-[100dvh] w-[280px] flex-col gap-5 border-r border-zinc-200 bg-white p-4 shadow-sm transition-transform duration-200 max-lg:-translate-x-full",
    "owner-sidebar": "max-lg:static max-lg:h-auto max-lg:translate-x-0",
    "sidebar-brand": "flex items-center gap-3 rounded-2xl px-2 py-2 font-extrabold tracking-tight text-zinc-900",
    "brand-mark": "grid h-9 w-9 place-items-center rounded-xl bg-emerald-600 text-sm font-extrabold text-white shadow-sm",
    ...
    "avatar": "grid h-8 w-8 place-items-center rounded-full border border-zinc-200 bg-zinc-50 object-cover text-sm font-bold text-zinc-900",
    "page-shell": "mx-auto w-[min(1240px,100%)] p-7 max-sm:p-4",
    "content": "mx-auto w-[min(1360px,100%)] p-7 max-sm:p-4 admin-page-enter",
    ...
    "panel": "overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm",
    ...
    "table-wrap": "overflow-x-auto rounded-2xl border border-zinc-200 bg-white shadow-sm [&_table]:min-w-[860px] [&_table]:w-full [&_table]:border-collapse [&_thead]:bg-zinc-50 [&_tbody]:divide-y [&_tbody]:divide-zinc-100 [&_tr]:transition [&_tbody_tr:hover]:bg-zinc-50 [&_th]:border-b [&_th]:border-zinc-200 [&_th]:px-5 [&_th]:py-3.5 [&_th]:text-left [&_th]:text-xs [&_th]:font-semibold [&_th]:uppercase [&_th]:tracking-wide [&_th]:text-zinc-500 [&_td]:whitespace-nowrap [&_td]:px-5 [&_td]:py-4 [&_td]:text-sm [&_td]:text-zinc-700",
