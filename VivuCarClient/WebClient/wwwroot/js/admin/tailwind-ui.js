(function () {
  const classMap = {
    ...
    "toolbar-admin-users": "grid-cols-[minmax(280px,1fr)_160px_180px_180px_72px_84px] items-center max-xl:grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1",
    ...
    "toolbar-trash": "grid-cols-[minmax(260px,1fr)_auto_auto]",
    ...
    "image-preview-grid": "mt-3 grid grid-flow-dense grid-cols-[repeat(auto-fill,minmax(128px,1fr))] gap-2.5 [&_img]:aspect-[4/3] [&_img]:w-full [&_img]:rounded-lg [&_img]:border [&_img]:border-[#e6e4df] [&_img]:object-cover",
